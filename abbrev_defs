...
(define-abbrev-table 'shampoo-cats-list-mode-abbrev-table '())

(define-abbrev-table 'shampoo-classes-list-mode-abbrev-table '())

(define-abbrev-table 'shampoo-code-mode-abbrev-table '())

(define-abbrev-table 'shampoo-list-mode-abbrev-table '())

(define-abbrev-table 'shampoo-methods-list-mode-abbrev-table '())

(define-abbrev-table 'shampoo-namespaces-list-mode-abbrev-table '())

(define-abbrev-table 'shampoo-working-mode-abbrev-table '())

(define-abbrev-table 'shampoo-workspace-mode-abbrev-table '())
